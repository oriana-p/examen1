...
<body>
    ...
    <div class="contenedor1">
       <button type="button" onClick="mostrarFoto5()" class="b1">Mostrar foto</button>
       <button type="button" onClick="ocultarFoto5()" class="b1">Ocultar foto</button>
    ...
    <div class="contenedor2">
        ...
        <form>
            ...
            <br><br>
            <button type="button" class="b1" onClick="validarTelefono5()">Validar</button>
        </form>
        <br>
